...
export function checkProduction(env) {
  const errors = [];
  for (const key of ["DOMAIN", "SITE_URL", "POSTGRES_PASSWORD", "RESTIC_PASSWORD", "SMTP_URL", "MAIL_FROM", "SEED_ADMIN_EMAIL", "SEED_ADMIN_PASSWORD"]) {
  ...
  if (env.CAPTCHA_TEST_MODE === "1") errors.push("生产环境不能启用 CAPTCHA_TEST_MODE");
